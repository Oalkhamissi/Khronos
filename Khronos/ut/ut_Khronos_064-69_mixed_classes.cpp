...
GATS_TEST_CASE(ut068_assignment_conversion_to_julian_tests, MIXED_CALENDAR_GROUP, 1) {
	...
	std::cout << "Test Case 68 1 julian: " << julian.day() << " : " << julian.month() << " : " << julian.year() << " : " << julian.hour() << " : " << julian.minute() << " : " << julian.second() << std::endl;
	std::cout << "Test Case 68 1 gregorian: " << epochGregorian.day() << " : " << epochGregorian.month() << " : " << epochGregorian.year() << " : " << epochGregorian.hour() << " : " << epochGregorian.minute() << " : " << epochGregorian.second() << std::endl;
